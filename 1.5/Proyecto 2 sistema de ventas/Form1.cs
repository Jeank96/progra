...
namespace Proyecto_2_sistema_de_ventas
{
    public partial class Form1 : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'sistemaVentasDataSet.PEDIDOS' Puede moverla o quitarla según sea necesario.
            this.pEDIDOSTableAdapter.Fill(this.sistemaVentasDataSet.PEDIDOS);
            // TODO: esta línea de código carga datos en la tabla 'sistemaVentasDataSet.CATALOGO_DE_PRODUCTOS' Puede moverla o quitarla según sea necesario.
            this.cATALOGO_DE_PRODUCTOSTableAdapter.Fill(this.sistemaVentasDataSet.CATALOGO_DE_PRODUCTOS);
            // TODO: esta línea de código carga datos en la tabla 'sistemaVentasDataSet.CLIENTES' Puede moverla o quitarla según sea necesario.
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection("Data Source=DESKTOP-FIMFG3S; Initial Catalog = SistemaVentas; Integrated Security = True;"))
            {
                ...
                SqlDataAdapter ver_carrito = new SqlDataAdapter("select * from carrito", conn);
